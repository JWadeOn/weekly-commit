...
const remotesMap = {
'weeklyCommitModule':{url:'http://localhost:3001/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
function App() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/auth/me`, { credentials: "include" }).then((res) => {
  ...
  if (!user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "1rem", fontFamily: "system-ui, sans-serif" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { style: { fontSize: "1.5rem", fontWeight: "bold" }, children: "Weekly Commit" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#6b7280" }, children: "Sign in to access your weekly commits." }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "system-ui, sans-serif" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontWeight: "600", fontSize: "0.875rem" }, children: "Weekly Commit" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "1rem" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "0.875rem", color: "#6b7280" }, children: user.email }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { style: { flex: 1 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "2rem", textAlign: "center", color: "#6b7280" }, children: "Loading..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      WeeklyCommitApp,
      {
        userId: user.userId,
        orgId: user.orgId,
