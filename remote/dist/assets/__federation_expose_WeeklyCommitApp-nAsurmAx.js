...
import { Q as QueryClient, j as jsxRuntimeExports, a as QueryClientProvider, M as MemoryRouter, A as ActiveRallyCryContext, u as useAuthStore, s as setAuthExpiredHandler, b as AppNav, R as Routes, c as Route, C as CommitPage, d as CommitDetailPage, e as CommitHistoryPage, f as ResourcesPage, B as BoardPage, g as ManagerDashboard, S as StrategyPage, N as Navigate } from './AppNav-Dbyk6-o-.js';
...
function WeeklyCommitApp({ onAuthExpired, activeRallyCryId }) {
  console.log("[WeeklyCommitApp] root render");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(MemoryRouter, { initialEntries: ["/"], initialIndex: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveRallyCryContext.Provider, { value: activeRallyCryId, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, { onAuthExpired }) }) }) });
}
